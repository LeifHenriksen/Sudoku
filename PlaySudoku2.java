...
public class PlaySudoku2 extends AppCompatActivity implements  View.OnClickListener{

    Sudo3x3 grillede3 = new Sudo3x3(50); //on créer un sudoku avec un tableau de case (9*9) dans la structure
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_sudoku2);
        final PlaySudoku2 activity = this;
